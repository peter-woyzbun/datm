...
.. raw:: html
    ...
    <div style="position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; max-width: 100%; height: auto;">
        <iframe src='//gifs.com/embed/pattern-base-demo-58Ek1B' frameborder='0' scrolling='no' width='100%'style='-webkit-backface-visibility: hidden;-webkit-transform: scale(1);' ></iframe>
    </div>
